  ...
  AT_DISPATCH_FLOAT_AND_BFLOAT16(
      input.scalar_type(), "multimem_all_reduce_", [&]() {
        DISPATCH_ALIGNMENTS_16_8_4(alignment, [&]() {
         hipLaunchKernelGGL(( multimem_all_reduce_kernel<scalar_t, k_alignment>)
              , dim3(num_blocks),
                 dim3(num_threads),
                 0,
...
at::Tensor multimem_one_shot_all_reduce_out(
  ...
  AT_DISPATCH_FLOAT_AND_BFLOAT16(
      input.scalar_type(), "multimem_one_shot_all_reduce", [&]() {
        DISPATCH_ALIGNMENTS_16_8_4(alignment, [&]() {
         hipLaunchKernelGGL(( multimem_one_shot_all_reduce_kernel<scalar_t, k_alignment>)
              , dim3(num_blocks),
                 dim3(num_threads),
                 0,
                 at::hip::getCurrentHIPStreamMasqueradingAsCUDA(), 
      ...
      input.scalar_type(), "one_shot_all_reduce", [&]() {
        DISPATCH_ALIGNMENTS_16_8_4(alignment, [&]() {
          DISPATCH_WORLD_SIZES(symm_mem->get_world_size(), [&]() {
           hipLaunchKernelGGL(( one_shot_all_reduce_kernel<scalar_t, k_alignment, k_world_size>)
                , dim3(num_blocks),
                   dim3(num_threads),
                   0,
                   at::hip::getCurrentHIPStreamMasqueradingAsCUDA(), 
...
at::Tensor two_shot_all_reduce_(
  ...
  AT_DISPATCH_FLOAT_AND_BFLOAT16(
      input.scalar_type(), "two_shot_all_reduce", [&]() {
        DISPATCH_ALIGNMENTS_16_8_4(alignment, [&]() {
          DISPATCH_WORLD_SIZES(symm_mem->get_world_size(), [&]() {
           hipLaunchKernelGGL(( two_shot_all_reduce_kernel<scalar_t, k_alignment, k_world_size>)
                , dim3(num_blocks),
                   dim3(num_threads),
                   0,
                   at::hip::getCurrentHIPStreamMasqueradingAsCUDA(), 
